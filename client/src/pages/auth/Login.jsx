        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2.5 mb-12">
            ...
            <div>
              ...
              <div className="text-xs text-teal-200/80">Ministry of Innovation and Technology</div>
            </div>
          </div>
          ...
          <p className="text-teal-100/90 text-base leading-relaxed max-w-md">
            Access designation applications, certificates, data rooms, and investor workflows.
          </p>
        </div>
        <p className="relative z-10 text-sm text-teal-200/60">Digital Ethiopia · MinT Portal</p>
      </div>
